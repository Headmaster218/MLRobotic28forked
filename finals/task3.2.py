...
def main():
    ...
    # Initialize lists to store errors and control torques for plotting
    tracking_errors = []
    control_torques = []
    ...
    for goal_position in goal_positions:
        ...
        while current_time < test_time_array.max():
            ...
            tracking_error = np.linalg.norm(q_mes - q_des)  # Euclidean distance between actual and desired joint positions
            tracking_errors.append(tracking_error)

            # Collect control torques
    ...
    # Plot the tracking errors and control torques
