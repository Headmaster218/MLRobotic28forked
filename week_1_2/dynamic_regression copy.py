...
def main():
    ...
    #ºÏ≤È≤–≤Ó
    print("Measured Torque:", tau_mes_all)
    print("Predicted Torque:",predicted_tau )
    ...
    plt.plot(time_vector, residuals_matrix[:, i], label=f'Joint {i+1} Residuals')
    plt.axhline(0, color='red', linestyle='--')  # ª≠“ªÃı¡„œﬂ
    plt.title(f'Residuals for Joint {i+1}')
